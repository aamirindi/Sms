<%@ Page Title="" Language="C#" MasterPageFile="~/UserMaster.Master" AutoEventWireup="true" CodeBehind="Complaints.aspx.cs" Inherits="SocietyManagementSystem.Complaints" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container-fluid px-4">
        ...
        <div class="action-buttons">
            <asp:Button ID="btnAdd" runat="server" Text="Add" CssClass="btn btn-success btn-sm" OnClick="btnAdd_Click" Visible="false" />
        </div>
    ...
    <Columns>
        ...
        <asp:BoundField DataField="created_at" HeaderText="Updated At" />
